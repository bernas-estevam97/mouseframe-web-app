...
function removeAllMeasurePoints() {
  ...
  canvas.removeEventListener("click", printMousePos);
  canvas.style.cursor = "default";
  document.getElementById("measureToCm").textContent = "";
  dist = 0;
}
...
function distanceMeasurePoint() {
  if (pointsMeasure.length != 0) {
    ...
    console.log(dist);
    appendSafeHTML(document.getElementById("measureToCm"), [
        '\u00A0', // non-breaking space (&nbsp;)
        `${parseFloat(dist)}px equals 1 centimeter.`
      ]);
...
let loadFile = function (event) {
  if (event.target.files[0]["type"].split("/")[0] === "image") {
    ...
    appendSafeHTML(imgSize, [
        (() => {
          const strong = document.createElement('strong');
          strong.textContent = 'Uploaded image size:';
          return strong;
        })(),
        ' ',
        `${(event.target.files[0].size / 1024).toFixed(2)} kb`
      ]);

    if (event.target.files[0].name.length > 30) {
      appendSafeHTML(imgName, [
        (() => {
          const strong = document.createElement('strong');
          strong.textContent = 'Image name:';
          return strong;
        })(),
        ' ',
  ...
  img.onload = () => {
    event.target.value = null;
    appendSafeHTML(imgWidth, [
        (() => {
          const strong = document.createElement('strong');
          strong.textContent = 'Uploaded image default width:';
          return strong;
        })(),
        ' ',
        `${img.width + "px"}`
    ...
    appendSafeHTML(imgHeight, [
        (() => {
          const strong = document.createElement('strong');
          strong.textContent = 'Uploaded image default height:';
          return strong;
        })(),
        ' ',
        `${img.height + "px"}`
    ...
    if (img.width >= 3000 || img.height >= 3000) {
      ...
      appendSafeHTML(document.getElementById("currentImgSize"), [
        ...
        ' ',
        `${img.width * 0.25}x${img.height * 0.25} (25% of size!)`,
        document.createElement('br'),
        '\u26A0\u00A0', // ⚠ + non-breaking space
        (() => {
          const i = document.createElement('i');
          i.textContent = 'Image was too big for your screen automatically set to 25% of the size.';
          return i;
        })()
      ]);
      ...
      appendSafeHTML(tableWarning, [
        ...
        ' ',
        'Image was redimensioned to 25% of its original size!'
      ]);
      ...
      appendSafeHTML(document.getElementById("currentImgSize"), [
        ...
        ' ',
        `${img.width * 0.75}x${img.height * 0.75} (75% of size!)`,
        document.createElement('br'),
        '\u26A0\u00A0', // ⚠ + non-breaking space
        (() => {
          const i = document.createElement('i');
          i.textContent = 'Image was too big for your screen automatically set to 75% of the size.';
          return i;
        })()
      ]);
      ...
      appendSafeHTML(tableWarning, [
        ...
        ' ',
        'Image was redimensioned to 75% of its original size!'
      ]);
      //A new column with original image size values in cm added.`;
      // document.getElementById("titleImage").colSpan = "6";
    } else if (
      ...
      appendSafeHTML(document.getElementById("currentImgSize"), [
        ...
        ' ',
        `${img.width * 0.50}x${img.height * 0.50} (50% of size!)`,
        document.createElement('br'),
        '\u26A0\u00A0', // ⚠ + non-breaking space
        (() => {
          const i = document.createElement('i');
          i.textContent = 'Image was too big for your screen automatically set to 50% of the size.';
          return i;
        })()
      ]);
     ...
     appendSafeHTML(tableWarning, [
        ...
        ' ',
        'Image was redimensioned to 50% of its original size!'
      ]);
      //A new column with original image size values in cm added.`;
    } else {
      imgSizeStatus = 100;
      ...
      // Update current image size safely
      appendSafeHTML(document.getElementById("currentImgSize"), [
        (() => {
          const b = document.createElement('b');
          b.textContent = 'Current image size is:';
    ...
    // canvasInfo.textContent = "<strong>Canvas default size is:</strong> " + canvas.width + "x" + canvas.height;
...
function resizeForty() {
  ...
  appendSafeHTML(document.getElementById("currentImgSize"), [
        ...
        ' ',
        `${img.width * 0.40}x${img.height * 0.40} (40% of size!)`,
        document.createElement('br'),
        '\u26A0\u00A0', // ⚠ + non-breaking space
        (() => {
          const i = document.createElement('i');
          i.textContent = 'Image was too big for your screen automatically set to 40% of the size.';
          return i;
        })()
      ]);
  ...
  appendSafeHTML(tableWarning, [
        ...
        ' ',
        'Image was redimensioned to 40% of its original size!'
      ]);
  //A new column with original image size values in cm added.`;
  imgSizeStatus = 40;
  // if (table.rows[1].cells.length < 6) {
...
//   document.getElementById("currentImgSize").textContent = "<b>Current image size is:</b> " + img.width*(value/20) + "x" + img.height*(value/20) + " (" +Math.round((value/20*100))+ "% of size!)";
// }
...
function getUserResolution() {
    appendSafeHTML(document.getElementById("userResolution"), [
    (() => {
      const strong = document.createElement('strong');
      strong.textContent = 'Your resolution is:';
      return strong;
    })(),
    ' ',
